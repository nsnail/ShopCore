...
export default {
    ...
    methods: {
        ...
        treeFilterNode(value, data) {
            ...
            const targetText = data.categoryName;
        ...
        nodeDrop(draggingNode, dropNode, dropType) {
            ...
            this.$message(
                `拖拽对象：${draggingNode.data.categoryName}, 释放对象：${dropNode.data.categoryName}, 释放对象的位置：${dropType}`
            );
        },
        //增加
        async add(node, data) {
            ...
            const newTreeData = {
                ...
                categoryName: newTreeName,
            };
            this.loading = true;
            const res = await this.$API["biz_productcategory"].create.post(
                newTreeData
            );
            this.loading = false;
        ...
        async delTree() {
            ...
            try {
                await this.$API["biz_productcategory"].bulkDelete.post(reqData);
