...
namespace ShopCore.Infrastructure.Constant;
...
public static class Numbers
{
    ...
    public const int  REGISTER_GIFT_GOLD        = 88;              // 注册送金币
    public const int  REGISTER_GIFT_SILVER      = 120;             // 注册送银币
    public const int  REGISTER_INVEST_GOLD      = 888;             // 注册投资金额
    public const int  SUPER_INVITE_CODE         = 88888888;        // 超级邀请码
}