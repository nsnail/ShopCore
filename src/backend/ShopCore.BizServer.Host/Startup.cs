using Prometheus;
using ShopCore.BizServer.Host.Extensions;
using ShopCore.Host.Extensions;
using ShopCore.Host.Middlewares;

namespace ShopCore.BizServer.Host;

/// <summary>
///     启动类
/// </summary>
public sealed class Startup : ShopCore.Host.Startup
{
    /// <summary>
    ///     程序入口
    /// </summary>
